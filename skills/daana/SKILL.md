...
1. `${CLAUDE_SKILL_DIR}/references/model-schema.md` — schema rules and validation constraints
2. `${CLAUDE_SKILL_DIR}/references/model-examples.md` — annotated YAML templates and patterns
